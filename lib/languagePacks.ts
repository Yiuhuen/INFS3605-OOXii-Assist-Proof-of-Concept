    ...
    prompts_json: [
      {
        ...
        spokenPrompt: "We are going to do a simple vision check now. You can answer in the language you are most comfortable with.",
      ...
      },
      {
        ...
        spokenPrompt: "Please cover your left eye now. Look at the chart, and read the smallest line you can see clearly.",
      ...
      },
      {
        ...
        spokenPrompt: "Please cover your right eye now. Look at the chart, and read the smallest line you can see clearly.",
      ...
      },
      {
        ...
        spokenPrompt: "Do you already wear glasses, or have glasses with you today? After trying these, tell me if the letters are blurry or uncomfortable.",
    ...
    prompts_json: [
      {
        ...
        spokenPrompt: "Yumi bai mekim liklik ai test. Yu ken bekim long tokples yu save gut long en.",
      ...
      },
      {
        ...
        spokenPrompt: "Pasim left ai. Rit long liklik lain yu inap lukim klia.",
      ...
      },
      {
        ...
        spokenPrompt: "Pasim right ai. Rit long liklik lain yu inap lukim klia.",
      ...
      },
      {
        ...
        spokenPrompt: "Yu gat glas nau? Taim yu traim dispela, lukluk i kamap klia na orait long ai?",
    ...
    prompts_json: [
      {
        ...
        spokenPrompt: "Bambae yumi mekem wan smol ae test. Yu save ansa long lanwis we yu harem gud long hem.",
      ...
      },
      {
        ...
        spokenPrompt: "Kavremap lef ae. Ridim smol laen we yu save luk klia.",
      ...
      },
      {
        ...
        spokenPrompt: "Kavremap raet ae. Ridim smol laen we yu save luk klia.",
      ...
      },
      {
        ...
        spokenPrompt: "Yu gat glas naoia? Taem yu traem hemia, lukluk blong yu i klia mo i harem gud?",
